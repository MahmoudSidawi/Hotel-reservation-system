...
export default function ReceptionistSidebar({
  ...
  return (
    <>
      {/* Mobile backdrop — only rendered/visible below lg, and only while open */}
      {isOpen && (
        <div
          onClick={onClose}
          aria-hidden="true"
      ...
      >
        <div>
          <div className="p-6 border-b border-[#27272A] flex items-center gap-3 relative">
            ...
            <button
              ...
              className="absolute right-4 top-4 lg:hidden p-1.5 rounded-lg text-zinc-400 hover:text-white hover:bg-[#27272A] transition"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
